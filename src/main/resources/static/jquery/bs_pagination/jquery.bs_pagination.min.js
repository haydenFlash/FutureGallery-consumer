...
"use strict";
(
    function(e){var d="bs_pagination";
    var b={
        init:function(g){
            var h=this;
            return this.each(function(){
                ...
                if(C.bootstrap_version=="3"){
                    ...
                    if(C.showRowsInfo){
                        w+='<div class="'+C.navInfoContainerClass+'">';
                        w+='<div id="'+m+'" class="'+C.navInfoClass+'"></div>';
                        w+="</div>"}}w+="</div>";h.html(w);
                        l=null;
                        i=C.currentPage;f(y,l,i,true,false);
                        h.removeClass().addClass(C.containerClass);
                        if(!C.directURL){
                            u="#"+k;h.off("click",u).on("click",u,function(){
                                var G=C.currentPage;
                                C.currentPage=1;
                                var F=C.currentPage;
                                f(y,G,F,true,true)
                            ...
                            h.off("click",z).on("click",z,function(I){
                                var H=C.currentPage;
                                var F=q.length;C.currentPage=parseInt(e(I.target).attr("id").substr(F));
                                var G=C.currentPage;
                                f(y,H,G,false,true)
                            })
                        }
            ...
            var g={
                currentPage:1,rowsPerPage:10,maxRowsPerPage:100,totalPages:100,totalRows:0,visiblePageLinks:5,
                showGoToPage:true,showRowsPerPage:true,showRowsInfo:true,showRowsDefaultInfo:true,directURL:false,
                disableTextSelectionInNavPane:true,bootstrap_version:"3",containerClass:"well",mainWrapperClass:"row",
                navListContainerClass:"col-xs-12 col-sm-12 col-md-6",navListWrapperClass:"",
                navListClass:"pagination pagination_custom",navListActiveItemClass:"active",
                navGoToPageContainerClass:"col-xs-6 col-sm-4 col-md-2 row-space",
                navGoToPageIconClass:"glyphicon glyphicon-arrow-right",navGoToPageClass:"form-control small-input",
                navRowsPerPageContainerClass:"col-xs-6 col-sm-4 col-md-2 row-space",
                navRowsPerPageIconClass:"glyphicon glyphicon-th-list",navRowsPerPageClass:"form-control small-input",
                navInfoContainerClass:"col-xs-12 col-sm-4 col-md-2 row-space",navInfoClass:"",
                nav_list_id_prefix:"nav_list_",nav_top_id_prefix:"top_",nav_prev_id_prefix:"prev_",
                nav_item_id_prefix:"nav_item_",nav_next_id_prefix:"next_",nav_last_id_prefix:"last_",
                nav_goto_page_id_prefix:"goto_page_",nav_rows_per_page_id_prefix:"rows_per_page_",
                nav_rows_info_id_prefix:"rows_info_",onChangePage:function(){},onLoad:function(){}};
            if(h=="2"){
                ...
                g.navGoToPageIconClass="icon-arrow-right";g.navGoToPageClass="small-input";
                g.navRowsPerPageWrapperClass="input-prepend rows_per_page_wrapper";
                g.navRowsPerPageIconClass="icon-th-list";g.navRowsPerPageClass="small-input";
                g.navInfoContainerClass="span2 row-space";g.navInfoClass=""
            }
            return g
        },getOption:function(g){
            var h=this;return h.data(d)[g]
        },getAllOptions:function(){
            var g=this;return g.data(d)
        },destroy:function(){
            var g=this;g.removeData()
        },setRowsInfo:function(g){
            var h=this,i=c(b.getOption.call(h,"getOption","nav_rows_info_id_prefix"),h.attr("id"));e("#"+i).html(g)}};
    var c=function(h,g){return h+g};
        ...
        if(J){
            ...
            if(B.totalPages<B.visiblePageLinks){
                ...
                if(z>B.visiblePageLinks*(C-1)){
                    ...
                    L=z%B.visiblePageLinks;q=L==0?-B.visiblePageLinks+1:-L+1;z+=q
                }
